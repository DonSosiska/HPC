...
const ForAuthors = (data) => {
    return (
        <div className="forAuthors">
            ...
            <div id="conferenceFee"><h1 >Conference FEE</h1><p> At least one author per paper should pay a Regular Registration fee in order to publish the paper. Otherwise, the paper will not be published in the Proceedings of HPC-UA 2020. Conference fee includes coffee breaks. Additional expenses: The costs for accommodation, food and travelling are not included in organizing fee. Payment should be performed after receiving the acceptance notification. All details regarding payment process are provided here. </p><p> {data.data.price} </p><p> Attendance of conference sessions without presentations is free of charge. Only registration on a conference site is required. </p></div>
